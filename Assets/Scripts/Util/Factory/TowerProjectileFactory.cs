...
public class TowerProjectileFactory : EntityFactory<TowerProjectile, TowerProjectiles>
{
    ...
    private void Awake()
    {
        ...
        EntityAddresses.Add(TowerProjectiles.Missile, "Assets/Prefabs/Entity/Projectile/Tower/missalie.prefab");
        EntityAddresses.Add(TowerProjectiles.Flame, "Assets/Prefabs/Entity/Projectile/Flame.prefab");
    }
}
