...
public class ShopData
{
    ...
    public ShopData()
    {
        ...
        // Equip
        products.Add("총", new Product("총", true, 0));
...
public class ProductData : MonoBehaviour
{
    ...
    public ProductData()
    {
        ...
        buyedEquip[0] = shopData.IsProductPurchased("총");
        buyedEquip[1] = shopData.IsProductPurchased("망치");
        ...
        priceEquip[0] = shopData.GetProductPrice("총");
        priceEquip[1] = shopData.GetProductPrice("망치");
    }
